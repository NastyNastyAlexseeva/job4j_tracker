...
public class Computer {
    ...
    private Computer(boolean multiMonitor, double ssd, String cpu) {
        this.multiMonitor = multiMonitor;
        this.ssd = (int) ssd;
        this.cpu = cpu;
    }

    private Computer(int ssd, String cpu) {
        this.ssd = ssd;
        this.cpu = cpu;
    }

    private Computer(boolean multiMonitor, int ssd, String cpu) {
        this.multiMonitor = multiMonitor;
        this.ssd = ssd;
        this.cpu = cpu;
    }
